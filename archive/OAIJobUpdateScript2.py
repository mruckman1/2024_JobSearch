...
class ResumeCustomizer:
    ...
    def extract_job_requirements(self, job_description: str) -> Dict:
        ...
        try:
            ...
            Analyze the job description and extract information in the following JSON format:
            {
                "required_skills": [],
            ...
            1. required_skills: List ALL technical and soft skills mentioned
            2. required_qualifications: Include education, certifications, and experience requirements
            3. key_responsibilities: Main duties and expectations of the role
            4. key_terms: Specific phrases or terminology used frequently in the description
            5. industry_specific_keywords: Domain-specific language and tools
            6. soft_skills: Leadership, communication, and interpersonal skills mentioned
            7. technical_skills: Specific tools, technologies, and technical competencies
            8. priorities: Key themes or emphases that appear to be particularly important
            
            Be thorough and detailed in your extraction. Include both explicit requirements and implicit preferences."""
    ...
    def customize_resume(self, resume_text: str, job_requirements: Dict) -> Tuple[str, List[Dict]]:
        ...
        - Naturally incorporate key terms from the job description
        ...
        - Highlight transferable skills when direct experience isn't available
        ...
        - If a required skill/experience isn't present, don't invent it
        ...
        [A JSON array of changes with:
            {
                ...
                "keywords_matched": ["list", "of", "relevant", "keywords", "integrated"]
            }
        ]
        """
    ...
    def customize_resume(self, resume_text: str, job_requirements: Dict) -> Tuple[str, List[Dict]]:
        ...
        prompt = """You are a professional resume customization expert. Given a resume and job requirements, 
        rewrite the resume to better match the job while maintaining absolute truthfulness. Focus on:
        1. Highlighting relevant skills and experiences
        2. Using similar terminology to the job requirements
        3. Maintaining professional tone and format
