...
class ResumeCustomizer:
    ...
    def extract_job_requirements(self, job_description: str) -> Dict:
        ...
        try:
            prompt = """You are a professional resume analyzer. Extract key information from the job description in the following JSON format:
            {
                "required_skills": [],
            ...
            Be specific and detailed in your extraction. Each array should contain relevant items found in the description."""
